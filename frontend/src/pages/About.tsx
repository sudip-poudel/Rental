        ...
        <div className=" w-2/3 ">
          <div className="mt-10 ml-20 ">
            ...
            <div>
              ...
              easy and convenient to find and rent the gear you need.
            </div>
          </div>
          <div className="mt-10 ml-20">
            <div className="flex  ">
          ...
          <div className="mt-10 ml-20 ">
            ...
            <div className="">
              <ol className="list-decimal list-inside ">
                <li className="my-2">
                  <strong> List Your Items:</strong> Have an item you’re not
                  using all the time? List it on Rentable and earn extra income.
                  Whether it’s a camera, bike, tent, kayak, or any other gear,
                  you can make it available to your local community.
                </li>
                <li className="my-2">
                  <strong>Find What You Need:</strong> Browse our extensive
                  catalog of items available for rent. Use our search and filter
                  features to find exactly what you’re looking for, when you
                  need it.
                </li>
                <li className="my-2">
          ...
          <div className="mt-10 ml-20">
            ...
            <div>
              <ul className="list-disc list-inside">
                ...
                <li className="my-2">
                  <strong>Affordable: </strong>Renting is often much cheaper
                  than buying, especially for items you only need temporarily.
                </li>
                <li className="my-2">
