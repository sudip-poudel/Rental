          ...
          <div className=" flex items-center justify-center">
            <div className=" m-20 h-46 w-4/5 flex flex-row">
              <div className="w-1/2 m-10  shadow-md bg-white border rounded-lg flex items-center justify-center transform transition duration-500 ease-in-out hover:scale-105">
                <img className="w-full h-auto " src={item.pictureUrl[0]} alt="Camera" />
              </div>
              <div className=" w-1/2 m-10 flex flex-col p-5">
                <img
                  ...
                  className="h-10 w-10"
                />
                <div className=" text-2xl  font-bold mt-2">{item.title}</div>
                <div className="mt-2 flex flex-col border rounded-md shadow-md bg-white p-5">
                  <div className="mt-2">Rs.{item.rate}</div>
                  <div className="text-lg mt-2">{item.description}</div>
